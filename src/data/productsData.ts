  ...
  },
{
    ...
    recommendedUses: [
      "طلاء برايمر عام على الأسطح الخرسانية الجافة",
      "طلاء برايمر على الأسطح المعدنية وأنظمة طلاء السيارات",
      "الهياكل المنزلية والصناعية",
      "محطات الكيماويات ومحطات الطاقة ومحطات النفط",
      "طلاء وسيط فوق EPX01-40 للحماية ضد التآكل",
      "هياكل الفولاذ البحري (خدمة غير غوصية)"
    ],
    features: [
      "تماسك ممتاز",
      "مقاومة جيدة للتآكل",
      ...
      "مناسب للخدمة الغوصية أو غير الغوصية مع الطلاء العلوي المناسب",
      "مقاوم للحرارة المستمرة حتى 140 درجة مئوية (خدمة غير غوصية)"
    ],
    instructions: [
      "طريقة التطبيق: رش الهواء أو التقليدي، فرشاة أو أسطوانة"
    ],
    usage: {
      mixingRatio: "4:1 (A:B) بالحجم",
      mixingMethod: "تحريك المكونات جيدًا ثم دمجها باستخدام محرك بطيء لمدة 3 دقائق على الأقل. يمنع استخدام محرك عالي السرعة.",
      thinnerCleaner: "S405 (Epoxsol) للتخفيف والتنظيف. تختلف النسبة حسب درجة الحرارة وطريقة التطبيق."
    },
    dryingTime: {
      finalCure: "7 أيام"
    },
    technicalSpecs: [
      "عند إعادة الطلاء يجب مراعاة أوقات الجفاف (الحد الأدنى والحد الأقصى).",
      "درجة حرارة التطبيق لا تقل عن 10°م ويجب أن تكون 3°م أعلى من نقطة الندى.",
      "لا تعرض الطلاء للماء أو المواد الكيميائية قبل تمام الجفاف."
    ],
    packaging: [
      { size: "20 لتر", type: "طقم (A+B)" },
      { size: "5 لتر", type: "طقم (A+B)" }
    ],
    storage: [
      "يحفظ في مكان جاف وبارد",
      "تجنب أشعة الشمس المباشرة",
      "درجة الحرارة: 5°م – 35°م"
    ],
    safety: {
      precautions: [
      ...
      firstAid: [
        "عند ملامسة الجلد: غسل بالماء والصابون",
        "عند ملامسة العينين: شطف جيد واستشارة الطبيب",
        "في حال الاستنشاق: نقل المصاب لمكان جيد التهوية"
      ]
    },
    note: "كافة المعلومات في هذه النشرة نتيجة لتجارب مخبرية وخبرات عملية. النتائج النهائية تعتمد على مهارة المستهلك ومدى التزامه بالتعليمات. تحتفظ الشركة بحق تغيير المواصفات دون إشعار مسبق."
  }
];
