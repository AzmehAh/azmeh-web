...
],
{
  ...
  images: [
    "/images/products/epx02-1.jpg",
    "/images/products/epx02-2.jpg"
  ],
  technicalDescription: "يعد EPX02 طلاءً بطبقتين (A & B) يحتوي على بولي أميد كمادة رابطة ويستخدم كطلاء برايمر وطلاء وسيط عالي الكثافة من الإيبوكسي.",
  technicalSpecs: [
    { property: "نسبة المزج", value: "4:1 (A:B)", standard: "" },
    { property: "طريقة المزج", value: "خلط جيد باستخدام محرك بطيء لمدة 3 دقائق على الأقل", standard: "" },
    { property: "المذيب / المنظف", value: "S405 (Epoxsol)", standard: "" },
    { property: "زمن الجفاف - التفاعل النهائي", value: "7 أيام", standard: "" },
    { property: "مقاومة الحرارة", value: "حتى 140 °م (خدمة غير غوصية)", standard: "" }
  ],
  applications: [
    "يستخدم كطلاء برايمر عام على الأسطح الخرسانية الجافة.",
    "يستخدم كطلاء برايمر على الأسطح المعدنية وفي أنظمة الطلاء السيارات.",
    "الهياكل المنزلية والصناعية.",
    "محطات الكيماويات ومحطات الطاقة ومحطات إنتاج النفط.",
    "طلاء وسيط فوق EPX01-40 للحماية ضد التآكل.",
    "الهياكل الفولاذية البحرية (خدمة غير غوصية)."
  ],
  features: [
    "تماسك ممتاز.",
    "مقاومة جيدة للتآكل.",
    "خصائص حاجز ممتازة.",
    "يناسب مجموعة متنوعة من الأسطح.",
    "طلاء وسيط فوق EPX01-40.",
    "قابل للطلاء بمجموعة واسعة من الطلاءات العلوية.",
    "مقاوم للحرارة حتى 140 درجة مئوية (خدمة غير غوصية).",
    "يمكن استخدامه في الخدمة الغوصية مع طلاء علوي مناسب."
  ],
  instructions: [
    "طريقة التطبيق: رش الهواء أو التقليدي، فرشاة أو أسطوانة.",
    "تحريك المكونات الفردية جيدًا قبل الخلط.",
    "خلط المكونات (A و B) بالنسب المحددة باستخدام محرك بطيء لمدة 3 دقائق.",
    "لا تخلط أكثر من الكمية التي يمكن استخدامها خلال حياة الوعاء.",
    "تنظيف الأدوات مباشرة باستخدام S405 بعد الاستخدام."
  ],
  packaging: [
    { size: "20 لتر", type: "طقم (A+B)", coverage: "" },
    { size: "5 لتر", type: "طقم (A+B)", coverage: "" }
  ],
  storage: [
    "يحفظ في مكان جاف وبارد.",
    "تجنب التعرض لأشعة الشمس المباشرة.",
    "درجة حرارة التخزين: من 5°م إلى 35°م."
  ],
  safety: {
    precautions: [
      "يجب ارتداء القفازات والنظارات الواقية أثناء الاستخدام.",
      "تجنب ملامسة الجلد والعينين.",
      "تجنب الاستنشاق المباشر للأبخرة."
    ],
    firstAid: [
      "في حالة ملامسة الجلد: غسل المكان بالماء والصابون.",
      "في حالة ملامسة العينين: شطف جيد بالماء واستشارة الطبيب.",
      "في حالة الاستنشاق: نقل المصاب إلى مكان جيد التهوية."
    ]
  }
}
];
