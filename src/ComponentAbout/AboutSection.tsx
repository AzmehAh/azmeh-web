  ...
  >
    ...
    <div className="relative z-10 flex flex-col justify-between h-full">
      <div>
        ...
        <h2 className="text-4xl md:text-4xl font-semibold text-white mb-6 leading-tight text-right">
          Al Azmeh Paints – Excellence Since 1955
        </h2>
        <p className="text-blue-100 mb-8 leading-relaxed text-lg text-right">
        ...
        <div className="text-white/90 mb-8 text-sm uppercase tracking-wide font-medium text-right">
