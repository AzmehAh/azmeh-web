    ...
    >
      ...
      <div className="p-8">
        ...
        <div className="flex items-center gap-4 mb-4">
          <div
            className={`w-16 h-16 rounded-2xl text-gradient-to-br ${goal.gradient} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
          >
