          ...
          {goals.map((goal, index) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <div 
                  className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${goal.gradient} flex items-center justify-center  group-hover:scale-110 transition-transform duration-300`}
                >
