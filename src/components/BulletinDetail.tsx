      ...
      <div className="bg-logo text-white py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-start">
          ...
          <div className="flex items-center gap-3 mb-4">
            <span className="px-5 py-3 bg-white/20 rounded-full text-sm font-medium ">
              {categoryDisplayName}
            </span>
          ...
          <h1 className="text-2xl md:text-5xl font-bold mb-6 leading-tight">{title}</h1>
             <button
                  ...
                  className="bg-green-300/10 hover:bg-white/20 text-white px-8 py-3 rounded-lg font-semibold transition-colors backdrop-blur-sm"
                >
