...
<div className="relative flex justify-center w-full max-w-md lg:max-w-lg mx-auto">
  ...
  {/* Counter Badge - Sticker Style */}
  <motion.div
    className={`absolute bottom-2 sm:bottom-4 ${
      isRTL ? 'right-2 sm:right-8' : 'left-2 sm:left-8'
    } bg-white rounded-r-2xl px-4 sm:px-8 py-2 sm:py-4 shadow-xl flex flex-col items-center justify-center transform sm:rotate-[-3deg] w-[85%] sm:w-[70%]`}
