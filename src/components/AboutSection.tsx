...
const AboutSection = () => {
  ...
  {/* Counter Badge - Circle */}
     <motion.div
  className="absolute bottom-1 left-1 bg-white rounded-xl shadow-xl w-24 h-24 sm:w-28 sm:h-28 flex flex-col items-center justify-center border-2 border-logo"
