...
<motion.div
  ...
  style={{
    ...
    backgroundColor: "#425e44", // اللون صلب وواضح
    width: cardPositions[hoveredCard-1]?.width || 100,
    height: cardPositions[hoveredCard-1]?.width || 100,
    x: cardPositions[hoveredCard-1]?.x + (cardPositions[hoveredCard-1]?.width || 0)/2,
    y: cardPositions[hoveredCard-1]?.y + (cardPositions[hoveredCard-1]?.height || 0)/2
  }}
/>
