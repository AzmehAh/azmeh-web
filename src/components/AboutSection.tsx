          ...
          >
            {cards.map((card, index) => (
              ...
              >
                ...
                {/* Improved Expanding Circle Effect - Similar to the button effect */}
                <motion.div
                  className="absolute z-5 bg-white rounded-full origin-center"
                  initial={{ 
                    scale: 0,
                    opacity: 0,
                    x: "-50%",
                  ...
                  animate={{
                    ...
                    transform: hoveredCard === card.id 
                      ...
                      : "translate3d(0px, -50%, 0px) scale3d(0, 0, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)"
                  }}
                  transition={{ 
                    duration: 0.6, 
                    ease: "easeOut"
