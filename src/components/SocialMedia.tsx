...
const SocialMedia = () => {
  ...
  return (
   ...
   <a
  href="#"
  className="flex items-center bg-[#0055a3] text-white rounded-full px-4.5 py-3 h-12 overflow-hidden transition-all duration-500 ease-in-out w-12 hover:w-60 group shadow-lg hover:shadow-2xl origin-left whitespace-nowrap"
>
