    ...
    <section className="py-20 relative  bg-gray-50">
      ...
      Creative Vibes
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
         <a
  href="#"
  className="flex items-center justify-center bg-[#0055a3] text-white rounded-full h-12 w-48 overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 ease-in-out group"
>
  <div className="flex items-center transform transition-transform duration-500 group-hover:-translate-x-4">
