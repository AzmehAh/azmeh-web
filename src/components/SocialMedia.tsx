...
const SocialMedia = () => {
  ...
  return (
   ...
   <a
  href="#"
  className="flex items-center bg-[#0055a3] text-white rounded-full h-12 w-12 hover:w-52 overflow-hidden transition-all duration-500 ease-in-out shadow-lg hover:shadow-2xl origin-left group"
>
