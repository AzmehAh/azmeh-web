...
">
              <a
  href="#" 
  className="flex items-center bg-[#0055a3] text-white rounded-full px-3 py-3 h-12 overflow-hidden transition-all duration-500 ease-in-out w-[40px] hover:w-[200px] 
