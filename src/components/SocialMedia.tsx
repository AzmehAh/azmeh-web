  ...
  <div className="flex items-center  flex justify-start w-full "> 
    ...
    <span className="ml-3 opacity-0 group-hover:opacity-100 transition-all duration-300">
       Like on Facebook
           ...
           <a
  href="#" 
  className="flex items-center bg-[#0055a3] text-white rounded-full px-3.5 py-3 h-12 overflow-hidden transition-all duration-500 ease-in-out w-15 hover:w-55 group shadow-lg hover:shadow-2xl origin-left whitespace-nowrap"
>
  <div className="flex items-center  flex justify-start w-full "> 
