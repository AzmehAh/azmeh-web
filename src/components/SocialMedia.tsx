...
const SocialMedia = () => {
  ...
  return (
   ...
   <a
  href="#"
  className="flex items-center bg-[#0055a3] text-white rounded-full px-4 py-3 h-12 overflow-hidden transition-all duration-500 ease-in-out w-12 hover:w-55 group shadow-lg hover:shadow-2xl origin-left whitespace-nowrap"
>  
  <div className="flex items-center  justify-start mr-1 w-full">
