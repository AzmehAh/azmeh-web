    ...
    <div className={`min-h-screen bg-gray-50 pt-28 ${isRTL ? 'rtl' : 'ltr'}`}>
      ...
      <div className="max-w-7xl  mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col lg:flex-row gap-8">
          {/* Filters Sidebar */} 
         <div className="lg:w-80  flex-shrink-0 fixed top-24">
  <div className=" sticky top-24">
    <div className="bg-white rounded-xl shadow-lg p-6 max-h-[calc(100vh-7rem)]  no-scrollbar">
                    ...
                    >
                      ...
                      <div className="p-6 flex-grow flex flex-col justify-between">
                        <div>
                          ...
                          <h3 className="text-lg font-bold text-gray-900 mb-3 group-hover:text-logo transition-colors  min-h-[3rem]">
                            {displayTitle}
                          </h3>
