  ...
  const backgrounds = [
    {
      ...
      productCode: 'N°2570',
      brushColor: 'red' // لون الفرشاة مطابق للدائرة
    },
    {
      ...
      productCode: 'N°2571',
      brushColor: '#4A90E2' // لون الفرشاة مطابق للدائرة
    },
    {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 flex items-center justify-between h-full">
        ...
        <div className="hidden lg:block flex-shrink-0 ml-16">
          ...
          >
            {/* الدائرة الكبيرة */}
            <div 
              className="absolute w-40 h-40 rounded-full transition-colors duration-500"
              style={{ 
