...
const Hero = () => {
  ...
  // عرض عادي للشاشات الكبيرة والمتوسطة
  if (!isMobile) {
    return (
          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-0 z-10 flex flex-col justify-center items-start p-6">
                ...
                {/* العنوان - يظهر دائمًا في الموبايل */}
                <div
                ...
                <motion.div
                  ...
                  transition={{ delay: 0.3, duration: 0.5 }}
                >
                  <p className="text-lg mb-4 text-white leading-relaxed drop-shadow-lg">
                    {isRTL && category.description_ar ? category.description_ar : category.description}
                  </p>
                  <motion.button
                    onClick={() => {
