  ...
  <div className="min-h-screen bg-gray-50 pt-20">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center mb-16">
        <h1 className="text-5xl md:text-6xl font-bold text-logo mb-6">
          {t('faq.title')}
        </h1>
          ...
          >
            <div className="p-8 flex flex-col flex-grow">
              <div className="flex mb-4">
                <div className="w-12 h-12 flex-shrink-0 bg-logo rounded-xl flex items-center justify-center mr-4">
    ...
    return (
      <div className="min-h-screen bg-gray-50 pt-20 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/faq" className="bg-logo text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors">
        ...
        <div className="mb-12">
          <div className="relative max-w-md mx-auto">
            ...
            <input
              ...
              className={`w-full ${currentLang === 'ar' ? 'pr-12 pl-4' : 'pl-12 pr-4'} py-3 border border-gray-200 rounded-xl focus:outline-none focus:border-logo focus:ring-2 focus:ring-logo/20 transition-all`}
            />
          </div>
          {searchTerm && (
              ...
              >
                ...
                >
                  <div className="flex items-start space-x-4 flex-1">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 group-hover:text-logo transition-colors leading-relaxed">
                  ...
                  >
                    <ChevronDown className="w-5 h-5 text-gray-400 group-hover:text-logo" />
                  </motion.div>
                </button>
